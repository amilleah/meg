...
def sendTrigger(channel, duration = 0.01,zero_marker='mh\x00'):
    ...
    mapping_bin_ascii = {'ch160':'mh\x01','ch161':'mh\x02','ch162':'mh\x04','ch163':'mh\x08',
                         'ch164':'mh\x10','ch165':'mh 0','ch166':'mh@0'}
...
#sending marker
# sendTrigger(f'ch160',duration=0.01)
# sendTrigger(f'ch161',duration=0.01)
# sendTrigger(f'ch162',duration=0.01)
# sendTrigger(f'ch163',duration=0.01)
# sendTrigger(f'ch164',duration=0.01)
# sendTrigger(f'ch165',duration=0.01)
# sendTrigger(f'ch166',duration=0.01)