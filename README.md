...
### Analysis
#### sensor space
The `sensor_space.ipynb` includes basic visualization and clustering permutation test of epoched sensor data. It calculates global field power (GFP) across all sensors and runs spatiotemporal clustering with a basic permutation test.
